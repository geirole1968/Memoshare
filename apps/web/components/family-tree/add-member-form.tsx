...
import { RelationType } from "./add-member-selection";
...
export function AddMemberForm({ isOpen, onClose, onSubmit, onDelete, relationType, relativeName, initialData }: AddMemberFormProps) {
    ...
    const handleDelete = () => {
        ...
        if (initialData?.id && onDelete) {
            if (window.confirm("Er du sikker på at du vil slette denne personen?")) {
                console.log("Confirming delete for ID:", initialData.id);
                onDelete(initialData.id);
                onClose();
            }
        } else {
            console.error("Cannot delete: Missing initialData.id or onDelete prop");
        }
    };
